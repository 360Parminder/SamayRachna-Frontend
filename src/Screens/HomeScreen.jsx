...
const HomeScreen = () => {
    ...
    return (
        <View style={GlobalStyles.container}>
            <TouchableOpacity style={{ width: '100%', flexDirection: 'row', alignItems: 'center' }} onPress={() => navigation.navigate('Profile')}>
    ...
    userData?.profilePic
      ...
      : require('../Assets/profile.jpeg') 
            ...
            <View style={{ width: '100%', flexDirection: 'row', flexWrap: 'wrap', gap: 10, marginTop: 30, justifyContent: 'center' }}>
                ...
                <SmallCard title="Active Time Tables" location="CreatedTimetables" icon={require('../Assets/inuse.png')} />
